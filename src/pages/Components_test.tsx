...
function ComponentsTest() {
  ...
  return (
    <div>
      <p>ComponentsTest page</p>
      <div>
        <Avatar
          src={profile_default || undefined}
          {...(profile_default ? {} : stringAvatar(user_name))}
        />
        <Avatar
        ...
        <Avatar
          src={profile_default}
          {...(profile_default ? { profile_default } : stringAvatar(user_name))}
        />
        <Avatar {...(profile_default ? {} : stringAvatar(user_name))} />
        <Avatar />
